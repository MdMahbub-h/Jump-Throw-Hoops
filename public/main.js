  ...
  addHomeUI() {
    ...
    this.titleText = this.add
      .text(
        400,
        550,
        "Jump through the hoops and collect good\nbacteria a long the way to earn extra points.\nUnlock hidden offers in Rabble cashback\napp the higher score you get.",
        {
    ...
    this.option1 = this.add
      .rexRoundRectangle(400, 830, 520, 100, 50, 0x335519)
      .setDepth(5)
      .setScrollFactor(0)
      .setInteractive();
    ...
    this.option2 = this.add
      .rexRoundRectangle(400, 945, 520, 100, 50, 0x2d8d68)
      .setDepth(5)
      .setScrollFactor(0)
      .setInteractive();
    ...
    this.physics.add.overlap(this.player, hoopCollide, () => {
      if (!this.player.lost) {
        ...
        let pointAddText = this.add
          .text(hoopCollide.x, hoopCollide.y, `+${this.pointTimes}`, {
            fontSize: "34px",
            color: "#7b46bb",
            fontStyle: "bold",
          })
        ...
        this.tweens.add({
          ...
          x: this.player.x + this.player.speed - 130,
          y: 50,
          ease: "Power1",
          duration: 500,
          delay: 200,
